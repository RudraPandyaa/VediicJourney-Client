<template>
  <main class="india-page">
    ...
    <section class="india-hero">
      <div class="india-hero__content">
        ...
        <p class="india-hero__description body-large">
          A land of vibrant cultures, ancient ruins, and breathtaking natural wonders. Explore our curated experiences across South America.
        </p>
      </div>
    </section>
    ...
    <section class="states-section" ref="statesSection">
      <DestinationsGrid :states="states" basePath="/destinations/south-america" />
    </section>
  </main>
</template>
