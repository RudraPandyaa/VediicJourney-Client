<template>
  <main class="india-page">
    ...
    <section class="india-hero">
      <div class="india-hero__content">
        ...
        <p class="india-hero__description body-large">
          A land of ancient wisdom, vibrant colors, and profound spirituality. Explore our curated experiences across the majestic states of India.
        </p>
      </div>
    </section>
    ...
    <section class="states-section" ref="statesSection">
      <DestinationsGrid :states="states" basePath="/destinations/india" />
    </section>
  </main>
</template>
