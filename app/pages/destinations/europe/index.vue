<template>
  <main class="india-page">
    ...
    <section class="india-hero">
      <div class="india-hero__content">
        ...
        <p class="india-hero__description body-large">
          A tapestry of history, art, and romantic landscapes. Explore our curated experiences across the iconic countries of Europe.
        </p>
      </div>
    </section>
    ...
    <section class="states-section" ref="statesSection">
      <DestinationsGrid :states="states" basePath="/destinations/europe" />
    </section>
  </main>
</template>
...
import { europeData as statesData } from '~/data/europeData'
